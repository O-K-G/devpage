...
const group1BackgroundColor = "linear-gradient(to bottom right, #ff616d 0%, #ffc171 100%)";
const group2BackgroundColor = "linear-gradient(to bottom right, #58ac30 0%, #a7df62 100%)";
const group3BackgroundColor = "linear-gradient(to bottom right, #37cfdc 0%, #5a88e5 100%)";
const group4BackgroundColor = "linear-gradient(to bottom right, #ff616d 0%, #ffc171 100%)";
const group5BackgroundColor = "linear-gradient(to bottom right, #37cfdc 0%, #5a88e5 100%)";
const group6BackgroundColor = "linear-gradient(to bottom right, #ff616d 0%, #ffc171 100%)";
const group7BackgroundColor = "linear-gradient(to bottom right, #58ac30 0%, #a7df62 100%)";
const group8BackgroundColor = "linear-gradient(to bottom right, #37cfdc 0%, #5a88e5 100%)";
const group9BackgroundColor = "linear-gradient(to bottom right, #58ac30 0%, #a7df62 100%)";
const group10BackgroundColor = "linear-gradient(to bottom right, #ff616d 0%, #ffc171 100%)";
